...
######################################################################################################
input_directories = ["gs://unicorn-qc/pre-imputation-qc/cohort-qc-crohns/bel1/share/eur(mainland).mt/",
                     "gs://unicorn-qc/pre-imputation-qc/cohort-qc-crohns/bel2/share/eur(mainland).mt/",
                     "gs://unicorn-qc/pre-imputation-qc/cohort-qc-crohns/chop/share/eur(mainland).mt/",
                     "gs://unicorn-qc/pre-imputation-qc/cohort-qc-crohns/germ/share/eur(mainland).mt/",
                     "gs://unicorn-qc/pre-imputation-qc/cohort-qc-crohns/nidk/share/eur(mainland).mt/",
                     "gs://unicorn-qc/pre-imputation-qc/cohort-qc-crohns/wtcc/share/eur(mainland).mt/"]
...
output_root_directory = "gs://unicorn-qc/pre-imputation-qc/array-qc-crohns"



def __main__(path_to_mt: str, output_root_directory:str, population:str, cohort_label:str,
    ...
    directory_structure = build_array_qc_directory_structure(output_root_directory, population=population, array=cohort_label)
...
for index, row in input_pandas.iterrows():
    __main__(path_to_mt=row['input_directories'],
             output_root_directory=output_root_directory,
             population=row['populations'],
             cohort_label=row['cohort_labels'],
